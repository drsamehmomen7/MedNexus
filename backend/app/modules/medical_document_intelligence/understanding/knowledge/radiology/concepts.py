...
from .context_concepts import RADIOLOGY_CONTEXT_DETAIL_CONCEPTS  # noqa: E402

RADIOLOGY_CONCEPTS = (RADIOLOGY_CONTEXT_CONCEPTS + RADIOLOGY_SECTION_CONCEPTS
                      + RADIOLOGY_MODALITY_CONCEPTS + RADIOLOGY_CONTEXT_DETAIL_CONCEPTS)
