...
RADIOLOGY_MODALITY_CONCEPTS = (
    ...
    RecognitionConcept("RAD_MODALITY_ULTRASOUND", "Ultrasound", Category.MODALITY, DocumentDomain.RADIOLOGY,
                       ...
                       external_references=_MODALITY_REFS),
    RecognitionConcept("RAD_MODALITY_DOPPLER", "Doppler ultrasound", Category.MODALITY, DocumentDomain.RADIOLOGY,
                       "Doppler", "دوبلر", ("Doppler ultrasound", "duplex ultrasound"), evidence_strength=2,
                       external_references=_MODALITY_REFS),
...
RADIOLOGY_SUBTYPE_SIGNALS = {
    ...
    DocumentSubtype.DOPPLER: RADIOLOGY_MODALITY_CONCEPTS[4].aliases,
    DocumentSubtype.MAMMOGRAPHY: RADIOLOGY_MODALITY_CONCEPTS[5].aliases,
    DocumentSubtype.NUCLEAR_MEDICINE: RADIOLOGY_MODALITY_CONCEPTS[6].aliases,
}
